...
기한이나 예산을 놓치는 것은 프로젝트 관리자가 직면하는 두 가지 일반적인 문제입니다. 여기에서 프로젝트 차질을 처리하는 방법을 보여줄 수 있습니다. [ STAR 방법 ](https://www.indeed.com/career-advice/interviewing/how-to-use-the-star-interview-response-technique) 을 사용하여 이 질문에 답할 수 있습니다. 
...
팀이 어려움을 겪고 있는 경우 도움을 주는 것은 프로젝트 관리자의 책임입니다. 이 질문은 귀하의 관리 및 리더십 기술을 입증할 수 있는 기회 입니다. 팀의 성공을 위해 얼마나 헌신했는지 보여줄 수 있습니다. 
